...
class LoanRequest(models.Model):
    ...
    approved_date = models.DateTimeField(null=True, db_column='fecha_aprovacion')
    denied_date = models.DateTimeField(null=True, db_column='fecha_rechazo')
    completed_date = models.DateTimeField(null=True, db_column='fecha_completado')
